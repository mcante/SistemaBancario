CREATE OR REPLACE PROCEDURE DEPOSITO_AHORRO
(MONTO IN FLOAT,   CTA_OR IN VARCHAR2,IN_LIBRETA NUMBER)
IS 
		...
		IF(V_TIPO_CUENTA=1) THEN
			...
			SELECT FECHA_VENCIMIENTO INTO V_LIB_FEC_VEN FROM LIBRETA WHERE NO_CUENTA=CTA_OR;
				IF (V_LIBRETA=1 AND V_STAT_LIBRETA='ACTIVA' AND V_LIBRETA2=IN_LIBRETA AND V_LIB_FEC_VEN>SYSDATE) THEN
					...
					VALUES (SYSDATE,CTA_OR,'DEPOSITO CON LIBRETA','BOLETA',BOLETA.NEXTVAL,'CORRECTO',V_SALDO_CUENTA,V_DIFERENCIA,MONTO,1);
					COMMIT;
...
--PRUEBAS
EXECUTE DEPOSITO_AHORRO(100,'2-001-0000001-9',1);
EXECUTE DEPOSITO_AHORRO(100,'1-001-0000002-5',2);
EXECUTE DEPOSITO_AHORRO(100,'1-002-0000001-8',2);
EXECUTE DEPOSITO_AHORRO(0,'1-002-0000001-8',2);
EXECUTE DEPOSITO_AHORRO(100,'1-002-0000001-8',1);
