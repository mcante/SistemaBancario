...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Depósito Ahorro</h1>
                </div>
            </div>
                        ...
                        <table border="0" width="300" align="left">
                            ...
                            <tr>
                                <td> 
                                    <div class="form-group">
                                        <label>LIBRETA</label>
                                        <input type="text" name="txtLibreta" value="" class="form-control" placeholder="LIBRETA"/>
                                    </div>
                                </td>
                            </tr>
                            
                            <th colspan="2">
                                <button type="submit" class="btn btn-primary" value="deposito_ahorro" name="accion">Depositar</button>
                            </th> 
                        </table>
                    </form>
                    </div>
