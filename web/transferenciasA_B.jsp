                        ...
                        <table border="0" width="300" align="left">
                            ...
                            <tr>
                                <td> 
                                    <div class="form-group">
                                        <label>DESTINO</label>
                                        <input type="text" name="txtDestino" value="" class="form-control" placeholder="Cta. Destino"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td> 
                                    <div class="form-group">
                                        <label>MONTO</label>
                                        <input type="text" name="txtMonto" value="" class="form-control" placeholder="Monto a Transferir"/>
                                    </div>
                                </td>
                            </tr>
                            
                            <th colspan="2">
                                <button type="submit" class="btn btn-primary" value="TransferenciaAB" name="accion">Transferir</button>
